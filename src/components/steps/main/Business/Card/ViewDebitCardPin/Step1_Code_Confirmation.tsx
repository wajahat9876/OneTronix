...
const Step1_Code_Confirmation = ({ next, parentGoto }: CardProps) => {
  ...
  return (
    ...
    >
      <View className="mx-4 mt-4">
        ...
        >
          We need to verify So enter the code sent via SMS below to View your
          Card Pin
        </Text>
...
export default Step1_Code_Confirmation;
