...
import ImgCreditCard from '@assets/images/home/img-blocked-credit-card.svg';
...
const Step3_Card_Blocked = ({ next, back }: MultiStepFormProps) => {
  return (
    <ScreenAuth
      title="Report Card"
      style={{
...
export default Step3_Card_Blocked;
